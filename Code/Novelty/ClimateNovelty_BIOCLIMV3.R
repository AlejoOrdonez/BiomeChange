  ...
  for (RCP in c("RCP26", "RCP46", "RCP60", "RCP85")){#(RCP <- c("RCP26", "RCP46", "RCP60", "RCP85")[1])
    if(length(grep(Model,dir(paste0("./Data/CMIP5/Processed/",RCP,"/BIOCLIM"))))!=0){
      ...
      for(YearUse in seq(2099,2299,by=50)){#(YearUse <- seq(2099,2299,by=50)[2])
       if(!paste0(Model,"_",RCP,"_",YearUse,"_SEDminSumm.tif")%in%dir("./Results/Novelty/BIOCLIM2/")){
         ...
         writeRaster(MDminSumm,
                     paste0("./Results/Novelty/BIOCLIM2/",Model,"_",RCP,"_",YearUse,"_MDminSumm.tif"),
                     overwrite = TRUE)
         ...
         writeRaster(SEDminSumm,
                     paste0("./Results/Novelty/BIOCLIM2/",Model,"_",RCP,"_",YearUse,"_SEDminSumm.tif"),
                     overwrite = TRUE)
