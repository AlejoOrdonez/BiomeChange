...
for (RCP in c("RCP26", "RCP45", "RCP60", "RCP85")){#(RCP <- c("RCP26", "RCP45", "RCP60", "RCP85")[1])
  ...
  if(!paste0("AllModels_",RCP,"_TreshSumm.rds")%in%dir(paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/"))){
    ...
    MDtreshDistList <- sfLapply(1:dim(values(BiomeBsLn,na.rm=T))[1],
                                function(x,
                                  ...
                                  ClimMn <- rast(paste0("./Results2/Novelty/AllModels_50km/",RCPUse,"/BIOCLIM2/ClimNormMn_1980-2010_",RCPUse,".tif"))
    ...
    SEDtreshDistList <- sfLapply(1:dim(values(BiomeBsLn,na.rm=T))[1],
                                 function(x,
                                   ...
                                   # Data frame with the Values
                                   ClimMn <- rast(paste0("./Results2/Novelty/AllModels_50km/",RCPUse,"/BIOCLIM2/ClimNormMn_1980-2010_",RCPUse,".tif"))
                                   ClimSD <- rast(paste0("./Results2/Novelty/AllModels_50km/",RCPUse,"/BIOCLIM2/ClimNormSD_1980-2010_",RCPUse,".tif"))
  ...
  for(YearUse in seq(2099,2299,by=50)){#(YearUse <- seq(2099,2299,by=50)[2])
    if(!paste0("AllModels_",RCP,"_",YearUse,"_SEDminSumm.tif")%in%dir(paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/"))){
      ...
      writeRaster(RCPFull,
                  paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/RCPFull_",YearUse,"_",RCP,".tif"),
                  overwrite = TRUE)
      ...
      MDmin <- sfLapply(1:dim(values(BiomeBsLn,na.rm=T))[1],
                        function(x,
                                 ...
                                 YearFut = YearUse){
                          # Future condition
                          TrgCellVals <- values(rast(paste0("./Results2/Novelty/AllModels_50km/",RCPUse,"/BIOCLIM2/RCPFull_",YearFut,"_",RCPUse,".tif")),na.rm=T)[x,]
      ...
      writeRaster(MDminSumm,
                  paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/AllModels_",RCP,"_",YearUse,"_MDminSumm.tif"),
                  overwrite = TRUE)
      ...
      SEDMin <- sfLapply(1:dim(values(BiomeBsLn,na.rm=T))[1],
                         function(x,
                           ...
                           # Baseline Data frame with the Values
                           ClimMn <- rast(paste0("./Results2/Novelty/AllModels_50km/",RCPUse,"/BIOCLIM2/ClimNormMn_1980-2010_",RCPUse,".tif"))
                           ClimSD <- rast(paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/ClimNormSD_1980-2010_",RCP,".tif"))
      ...
      writeRaster(SEDminSumm,
                  paste0("./Results2/Novelty/AllModels_50km/",RCP,"/BIOCLIM2/AllModels_",RCP,"_",YearUse,"_SEDminSumm.tif"),
                  overwrite = TRUE)      
